...
var SvgIcon = React10.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React10.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
  ...
  return (0, import_jsx_runtime6.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime5.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  ...
  return React11.memo(React11.forwardRef(Component));
}
...
//# sourceMappingURL=chunk-YXW3UCOK.js.map
